...
const areaChart = new ApexCharts(document.querySelector("#areaBasicChart"), areaChartOptions);
areaChart.render();
...
const spLineChart = new ApexCharts(document.querySelector("#splineChart"), spLineChartOptions);
spLineChart.render();
...
const timeSeriesChart = new ApexCharts(document.querySelector("#timeSeriesChart"), timeSeriesOptions);
...
const nullChart = new ApexCharts(document.querySelector("#nullValueChart"), nullChartOptions);
nullChart.render();
