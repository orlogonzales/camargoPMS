...
initLeafletMap('leafletMobileMap', (map) => {
    map.fitWorld();
...
// >>>------ Accessible maps -----------<<
initLeafletMap('leafletAccessibleMap', (map) => {
...
initLeafletMap('leafletMarkersMap', (map) => {
...
initLeafletMap('leafletInteractiveMap', (map) => {
...
initLeafletMap('leafletCustomIconsMap', (map) => {
...
initLeafletMap('leafletLayersMap', (map) => {
